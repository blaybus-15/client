...
const CenterIntroPage = () => {
    ...
    return (
            <div className="flex flex-col justify-evenly min-h-screen px-6 py-12 bg-white">
                <div className="w-full rounded-lg flex flex-col mt-12 mb-8 justify-center">
                    <h2 className="head-semi-bold-24 leading-[40px] text-left mb-3">
                        한줄 소개를 입력해주세요.
                    </h2>
                    <p className="body-regular-16 text-gray-1 mb-6">센터의 특징을 간단히 표현하면 매칭에 도움이 될 수 있어요. 부담 없이 자유롭게 작성해 주세요!</p>
                </div>

                <div className="flex flex-col flex-1 justify-start">
                    <label className="text-base font-normal text-dark mb-2">한줄 소개</label>
                    <textarea
                        value={introduction}
