    ...
    return (
        <div className="flex flex-col justify-evenly min-h-screen px-6 py-12 bg-white">
            <div className="w-full rounded-lg flex flex-col flex-1 justify-evenly">
                ...
                <h2 className="text-2xl leading-[40px] text-[#221313] font-semibold text-left py-6 mb-3">
                ...
                <div className="flex-1 flex flex-col items-center justify-end">
                    ...
                    <div className="flex justify-center sitems-center gap-[40px] mt-7">
                        <span className="text-sm font-semibold text-[#606265] cursor-pointer">아이디 찾기</span>
                        <div className="w-[1px] h-[16px] bg-[#B1B5B9]"></div>
                        <span className="text-sm font-semibold text-[#606265] cursor-pointer">비밀번호 찾기</span>
                    </div>
                </div>
            </div>
        </div>
